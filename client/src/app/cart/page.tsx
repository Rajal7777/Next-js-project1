...
//useSearchParams returns -> {step: "2"}
const CartPage = () => {
  ...
  function handleRemoveFromCart(product) {
    ...
    //get updated cart after removing
              ...
              {cart.map((item) => (
                <div className="flex items-center justify-between" key={item.id + item.selectedSize + item.selectedColor}>
                  ...
                  <button
                    ...
                    className="w-8 h-8 rounded-full bg-red-100 hover:bg-red-300 transition-all duration-300 text-red-400 flex items-center justify-center">
        ...
        <div className="w-full lg:w-5/12 shadow-lg border border-gray-100 p-8 rounded-lg flex flex-col gap-8 h-max">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex justify-between">
              <p className="text-gray-900 font-semibold">Shipping Fee</p>
              <p className="font-medium">
                ${cart.reduce((acc, item) => acc + item.price * item.quantity, 0).toFixed(2)}
